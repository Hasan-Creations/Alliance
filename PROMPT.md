# AI Prompt for Web App: Alliance

## 1. App Overview

**App Name:** Alliance

**Core Purpose:** Alliance is a personal productivity and life organization web application. It helps users manage their daily life through four integrated modules: a To-Do List, a Habit Tracker, an Expense Tracker, and user account management. The app uses Firebase for backend services, including authentication and a Firestore database for real-time data persistence.
